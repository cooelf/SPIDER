...
from modeling import (electra_uop, roberta_uop, bert_uop)
...
MODEL_CLASSES = {
    'bert': (BertConfig, bert_uop, BertTokenizer),
    'roberta': (RobertaConfig, roberta_uop, RobertaTokenizer),
    'electra': (ElectraConfig, electra_uop, ElectraTokenizer)
}
...
class InputFeatures(object):
    ...
    def __init__(self, example_id, choices_features, label):
        ...
        self.choices_features = [
            ...
            for input_ids, input_mask, segment_ids, sep_pos, turn_ids, shuffle_idx in choices_features
        ]
        self.label = label
...
def convert_examples_to_features(examples, label_list, max_seq_length, max_utterance_num,
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        for ending_idx, (text_a, text_b) in enumerate(zip(example.text_a, example.text_b)):
            ...
            choices_features.append((input_ids, input_mask, segment_ids, sep_pos, turn_ids, shuffle_idx))
        ...
        if ex_index < 10:
            ...
            for choice_idx, (input_ids, input_mask, segment_ids, sep_pos, turn_ids, shuffle_idx) in enumerate(choices_features):
...
def main():
    ...
    if args.do_train:
        ...
        train_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_sep_pos, all_turn_ids, all_shuffle_idx, all_label_ids)
        ...
        eval_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_sep_pos, all_turn_ids, all_shuffle_idx, all_label_ids)
